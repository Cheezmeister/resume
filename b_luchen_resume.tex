...
\section{\sc Employment}
    ...
    % thePlatform Comcast Technology Solutions provides custom solutions for digital media companies to manage and publish video and audio.
    % https://en.wikipedia.org/wiki/ThePlatform
    \begin{tabularx}
