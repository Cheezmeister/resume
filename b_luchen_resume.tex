...
\newcommand{\role}[5]{
  \begin{tabularx}
    \textbf{#1} (\href{https://#5}{#5}) & \hfill \textbf{#2} \\
    \textit{#3}   & \hfill #4          \\
  \end{tabularx}
}
...
\address{
  \texttt{brendan@\href{http://is.gd/bmlBio}{luchenlabs.com}} | \href{http://bml.rocks}{www.bml.rocks} | \href{https://linkedin.com/in/Cheezmeister}{\textsl{linkedin.com/in/Cheezmeister}} | \href{http://is.gd/bmlGithub}{\textsl{github.com/Cheezmeister}}
}
