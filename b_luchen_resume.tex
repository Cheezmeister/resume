...
\section{\sc Employer}
  \role
    {Archipelago AI (archipelago-ai.com)}
    {Distributed Remote}
  ...
  \impact{
    \item Currently bootstrapping the MVP of flagship product Fresnel
  }
  \technologies{
    Kotlin, Ktor, Klogging, Koin, SvelteKit, GitHub Actions, Docker, Dagger CI, Stytch, TiDB, Grafana, Ansible
  }
...
\section{\sc Past Employers}
    ...
    \impact{
        \item Drove company-wide initiatives to reduce HTTP 5xx and other failures, while sharing a 24/7 pager-duty rotation one out of every 3 weeks
    }
